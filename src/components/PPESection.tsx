...
const ppes: PPE[] = [
  {
    ...
    subtitle: "Architecture réseau trois tiers pour entreprise SaaS",
    date: "10 décembre 2025",
    context: "Promeo — Senlis",
    description:
      "Conception et déploiement d'une architecture réseau professionnelle en trois tiers (Access, Distribution, Core) pour l'entreprise InduSaaS. Mise en œuvre de VLAN, VLSM, HSRP, OSPF, EtherChannel (LACP), ACL et VPN IPsec pour garantir performance, redondance et sécurité.",
    ...
    outils: ["Cisco IOS", "Packet Tracer", "VLAN", "OSPF", "HSRP", "ACL", "IPsec"],
    pdfLink: "/docs/PPE1_InduSaaS.pdf",
  },
  {
    id: 2,
    title: "PPE 2 — Architecture réseau sécurisée",
    subtitle: "Infrastructure multi-zones WAN/LAN/DMZ avec pfSense",
    date: "21 janvier 2026",
    context: "Promeo — Senlis",
    description:
      "Conception et déploiement d'une architecture réseau sécurisée multi-zones (WAN, LAN, DMZ) pour l'entreprise NovaCyber avec pfSense. Configuration du pare-feu, règles de filtrage, proxy Squid, VPN, Active Directory et tests de sécurité offensive/défensive.",
    competences: ["SISR1 — Conception d'infrastructures réseau", "SISR2 — Installation et configuration", "SISR3 — Sécurisation des infrastructures"],
    outils: ["pfSense", "VMware", "Active Directory", "Squid", "VPN", "Kali Linux"],
    pdfLink: "/docs/PPE2_Architecture_Reseau.pdf",
  },
  {
    id: 3,
    title: "PPE 3 — Ansible & TechScale",
    subtitle: "Automatisation réseau multi-sites avec Ansible",
    date: "6 mars 2026",
    context: "Promeo — Senlis",
    description:
      "Automatisation de la configuration de plus de 200 équipements réseau répartis sur 3 datacenters (Paris, Lyon, Marseille) pour TechScale. Playbooks Ansible pour OSPF, HSRP, configuration de base, déploiement en masse et procédures de rollback.",
    competences: ["SISR4 — Administration des systèmes", "SISR5 — Supervision des réseaux", "Automatisation et IaC"],
    outils: ["Ansible", "YAML", "Linux", "SSH", "OSPF", "HSRP"],
